...
export const ApplicantInfoSection: React.FC<Props> = ({ data }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-16 text-xs w-full">
      <div>
        ...
        <p className="font-semibold text-slate-800 font-mono text-sm">{data.idNumber}</p>
      </div>
      ...
      <div>
        ...
        <p className="font-semibold text-slate-800 font-mono">{data.matriculationResult}</p>
      </div>
